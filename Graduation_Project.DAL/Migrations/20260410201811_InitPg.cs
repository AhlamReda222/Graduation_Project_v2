        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasAcceptedContract = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BusinessLicense = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BrandOwnerRequests", x => x.RequestId);
                    table.ForeignKey(
                        name: "FK_BrandOwnerRequests_Users_ReviewedBy",
                        column: x => x.ReviewedBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BrandOwnerRequests_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BrandOwnerId = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "NOW()"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Conversations_Users_BrandOwnerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "NOW()"),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    AverageRating = table.Column<decimal>(type: "numeric(3,2)", nullable: false, defaultValue: 0.00m),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BrandOwnerRequests_ReviewedBy",
                table: "BrandOwnerRequests",
                column: "ReviewedBy");

            migrationBuilder.CreateIndex(
                name: "IX_BrandOwnerRequests_Status",
                table: "BrandOwnerRequests",
                column: "RequestStatus");

            migrationBuilder.CreateIndex(
                name: "IX_BrandOwnerRequests_UserId",
                table: "BrandOwnerRequests",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Conversations_BrandOwnerId",
                table: "Conversations",
                column: "BrandOwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_Conversations_Customer_BrandOwner",
                table: "Conversations",
                columns: new[] { "CustomerId", "BrandOwnerId" },
                unique: true);
